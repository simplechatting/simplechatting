...
public class SCPacket implements Serializable{
    ...
    public static SCPacket serialize(ByteBuffer buffer) throws IOException, ClassNotFoundException {
        buffer.flip(); // direct buffer 의 경우
        byte[] buf = new byte[buffer.remaining()];
        buffer.get(buf);
        return SCPacket.serialize(buf);
    }

    public static SCPacket serialize(byte[] buf_array) throws IOException, ClassNotFoundException {
    ...
    public static ByteBuffer deserialize(SCPacket packet) throws IOException {
